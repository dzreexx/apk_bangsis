...
<main class="col-md-9 ms-sm-5 col-lg-8 px-md-1">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Form Magang Mahasiswa</h1>
    </div>
<form class="row g-3 mb-5" action="/magang/tambah" method="post" enctype="multipart/form-data" >
    ...
    <div class="col-md-6">
        ...
        <input type="number" name="nim" class="form-control @error('nim') is-invalid @enderror" id="nim" required value="{{ old('nim') }}">
        @error('nim')    
            <div class="invalid-feedback">
            {{ $message }}
            </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="univ" class="form-control @error('univ') is-invalid @enderror" id="univ" required value="{{ old('univ') }}">
        @error('univ')    
            <div class="invalid-feedback">
            {{ $message }}
            </div>
    ...
    <div class="col-md-6">
        ...
        <input type="date" name="dateStart" class="form-control @error('dateStart') is-invalid @enderror" id="tangal" required value="{{ old('dateStart') }}">
        @error('dateStart')    
            <div class="invalid-feedback">
            {{ $message }}
            </div>
    ...
    <div class="col-md-6">
        ...
        <input type="date" name="dateEnd" class="form-control @error('dateEnd') is-invalid @enderror" id="tangal" required value="{{ old('dateEnd') }}">
        @error('dateEnd')    
            <div class="invalid-feedback">
            {{ $message }}
            </div>
