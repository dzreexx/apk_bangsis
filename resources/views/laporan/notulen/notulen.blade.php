...
<body>
        ...
        <table>
            ...
            <tbody id="allData">
                ...
                <tr>
                    ...
                    {{-- <td><a href="/permintaan/{{ $resume->id }}" target="_blank">Lihat</a></td> --}}
                    <td class="dropdown-btn text-decoration-none" onclick="toggleSubTable('subTable{{ $notulen->id }}', this)">Lihat</td>
                ...
                <tr id="subTable{{ $notulen->id }}" class="sub-table">
                    <td colspan="8">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $notulen->id }}</td>
                                    <td>{{ $notulen->keterangan }}</td>
                                    <td><a href="/notulen/lihat/{{ $notulen->id }}" target="blank">lihat</a></td>
                                    {{-- <td><img src="{{ asset('storage/'. $resume->dokumen) }}" alt=""></td> --}}
                                </tr>
                            </tbody>
                        </table>
                    </td>
    ...
    <div class="container">
        <form action="/notulen/tambah" method="get">
            <button class="btn btn-primary" type="submit">Tambah Notulen</button>
        </form>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus data Notulen?</p>
            </div>
