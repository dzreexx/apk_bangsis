...
<body>
        ...
        <table>
            ...
            <tbody id="allData">
                ...
                <tr>
                    ...
                    <td class="dropdown-btn text-decoration-none" onclick="toggleSubTable('subTable{{ $nodin->id }}', this)">Lihat</td>
                ...
                <tr id="subTable{{ $nodin->id }}" class="sub-table">
                    <td colspan="8">
                        <table>
                            <thead>
                                <tr>
    ...
    <div class="container">
        <form action="/nodin/tambah" method="get">
            <button class="btn btn-primary" type="submit">Tambah Nodin</button>
        </form>
    </div>
