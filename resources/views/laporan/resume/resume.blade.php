...
<body>
        ...
        <table>
            ...
            <tbody id="allData">
                ...
                <tr>
                    ...
                    <td class="dropdown-btn text-decoration-none" onclick="toggleSubTable('subTable{{ $resume->id }}', this)">Lihat</td>
                ...
                <tr id="subTable{{ $resume->id }}" class="sub-table">
                    <td colspan="8">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="/resume/lihat/{{ $resume->id }}" target="blank">lihat</a></td>
    ...
    <div class="container">
        <form action="/resume/tambah" method="get">
            <button class="btn btn-primary" type="submit">Tambah Resume</button>
        </form>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus data Resume?</p>
            </div>
