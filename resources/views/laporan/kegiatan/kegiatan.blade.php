...
<body>
        ...
        <table>
            ...
            <tbody id="allData">
                ...
                <tr>
                    ...
                    <td>{{ $laporan->personel }}</td>
                    <td>{{ $laporan->kegiatan }}</td>
                    <td><a href="/kegiatan/lihat/{{ $laporan->id }}" target="blank" class="text-decoration-none">Lihat</a></td>
                    <td><a href="/kegiatan/{{ $laporan->id }}/edit"><i class="bi bi-pencil-square"></a></td>
                    <td>
                        <button class="badge bg-danger border-0" onclick="openDeleteModal('{{ $laporan->id }}')">
    ...
    <div class="container">
        <form action="/kegiatan/tambah" method="get">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus data kegiatan?</p>
            </div>
