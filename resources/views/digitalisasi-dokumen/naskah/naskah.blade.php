...
<body>
    <main class="col-md-9 ms-sm-5 col-lg-8 px-md-1">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Digitalisasi Dokumen Naskah</h1>
        </div>
        <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Dokumen Naskah</th>
                    <th>Edit</th>
                    <th>Hapus</th>
                </tr>
            </thead>
            <tbody id="allData">
                @foreach ($naskahs as $key => $naskah)
                <tr>
    ...
    <div class="container">
        <form action="/naskah/tambah" method="get">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus Data Naskah?</p>
            </div>
