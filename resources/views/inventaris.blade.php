...
<body>
    <main class="col-md-9 ms-sm-5 col-lg-8 px-md-1">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Inventaris Bangsis</h1>
        </div>
        <div class="container">
            ...
            <div class="search">
                ...
                <tr>
                    ...
                    <td>{{ $inven->customJenis }}</td>
                        
                    @else

                    <td>{{ $inven->jenisBarang }}</td>
                    ...
                    <td class="text-bg-success">Baik</td>
                    
                    @elseif($inven->kondisi == 'rusak ringan')

                    <td class="text-bg-warning">Rusak Ringan</td>
                    
                    @else
                    
                    <td class="text-bg-danger">Rusak Berat</td>

                    @endif
                    <td>
                        <a href="/inventaris/{{ $inven->id }}/edit"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <div class="container">
            <form action="/inventaris-input" method="get">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus data Inventaris?</p>
            </div>
...
<script>
    ...
    function openDeleteModal(id) {
        ...
        deleteForm.action = '/inventaris/' + id;
