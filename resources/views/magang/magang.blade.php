...
<body>
    <main class="col-md-9 ms-sm-5 col-lg-8 px-md-1">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Magang Mahasiswa</h1>
        </div>
        <div class="container">
        ...
        <table id="allData">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/magang/{{ $magang->id }}/edit"><i class="bi bi-pencil-square"></a></td>
                    <td>
    ...
    <div class="container">
        <form action="/magang/tambah" method="get">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus data Magang</p>
            </div>
