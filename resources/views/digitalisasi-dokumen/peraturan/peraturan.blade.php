...
<body>
    <main class="col-md-9 ms-sm-5 col-lg-8 px-md-1">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Digitalisasi Dokumen Peraturan</h1>
        </div>
        <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Dokumen Peraturan</th>
                    <th>Edit</th>
                    <th>Hapus</th>
                </tr>
            </thead>
            <tbody id="allData">
                @foreach ($peraturans as $key => $peraturan)
                <tr>
    ...
    <div class="container">
        <form action="/peraturan/tambah" method="get">
            <button class="btn btn-primary" type="submit">Tambah Peraturan</button>
        </form>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Anda yakin ingin menghapus Data Peraturan?</p>
            </div>
    ...
    function openDeleteModal(id) {
        ...
        deleteForm.action = '/peraturan/' + id;
